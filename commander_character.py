...
def image_get_maximum_size_url(event):
    if event.object.message["attachments"].type == 'photo':
    #Need to add picture into the album
    print(event.object.message["attachments"][-1])
    return event.object.message["attachments"]
